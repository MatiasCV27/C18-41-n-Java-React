...
const UserHomeBannerView: React.FC<Props> = ({ name }) => {
    return (
        <div className="w-full h-[212px] bg-muted relative rounded-lg  overflow-hidden">
            <div className="w-2/3 flex flex-col justify-center items-start p-6 z-10">
                ...
                <p className="text-xl text-white text-pretty mb-4 z-10">
                    Bienvenido, activa tu agenda para impartir clases Quiero ser
                    tutor
                </p>
