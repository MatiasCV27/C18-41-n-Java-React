...
const UserHomeBannerView: React.FC = () => {
  return (
    <div className="w-[684px] h-[264px] bg-muted relative rounded-lg">
      <div className="w-2/3 flex flex-col justify-center items-start p-6 z-10 ">
        <h1 className="text-3xl font-bold mb-2 text-accent">¡Hola, Usuario!</h1>
        <p className="text-xl text-white text-balance mb-4">
          Bienvenido, activa tu agenda para impartir clases Quiero ser tutor
        </p>
        <Button
          className="bg-white text-black hover:bg-white border border-muted rounded-lg mt-8 z-10 hover:translate-x-1 transition-transform"
        >
      ...
      <img src={Book} alt="" className="absolute right-0 bottom-0 z-10" />
    </div>
  );
};
